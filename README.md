...
Deploy the org.crashub~vertx.shell~2.0.7 module from your verticle.
...
Install the shell module:
    ...
    vertx install org.crashub~vertx.shell~2.0.7
...
Create the file server.js:
    ...
    container.deployModule("org.crashub~vertx.shell~2.0.7", {
        "cmd": ".",
        "crash.auth": "simple",
        "crash.auth.simple.username": "admin",
        "crash.auth.simple.password": "admin",
...
($VERTX_MODS) as resources under $VERTX_MODS/org.crashub~vertx.shell~2.0.7/crash/commands/vertx :

    (! 561)-> ls -l $VERTX_MODS/org.crashub~vertx.shell~2.0.7/crash/commands/vertx
    total 40
