...
Deploy the org.crashub~vertx.shell~2.1.0 module from your verticle.
...
($VERTX_MODS) as resources under $VERTX_MODS/org.crashub~vertx.shell~2.1.0/crash/commands/vertx :
